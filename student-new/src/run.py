...
if args.function == 'pretrain':
    ...
    data = open(args.finetune_corpus_path).read()
    train_dataset = dataset.NameDataset(pretraining_dataset=pretrain_dataset,data=data)
    ...
    trainer.train()
    torch.save(model.state_dict(), "vanilla.model.params")
